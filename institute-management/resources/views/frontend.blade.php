...
<head>
    ...
    <script src="{{asset('frontend/assets/js/theme-script.js')}}" type="a860e97a09b072416dbc7e62-text/javascript"></script>
    ...
    <link rel="stylesheet" href="{{asset('frontend/assets/plugins/slick/slick-theme.cs')}}">
...
<body class="home-three">
    ...
    <div class="main-wrapper">
                    ...
                    <div class="container">
                        <div class="navbar-header">
                            ...
                            <a href="{{url('/')}}" class="navbar-brand logo">
                                <img src="{{asset('frontend/logo.png')}}" class="img-fluid" alt="Logo">
                            </a>
                        </div>
                        <div class="main-menu-wrapper">
                            <div class="menu-header">
                                <a href="{{url('/')}}" class="menu-logo">
                                    <img src="{{asset('frontend/assets/img/logo/logo.svg')}}" class="img-fluid" alt="Logo">
                                </a>
                        ...
                        <ul class="nav header-navbar-rht align-items-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link login-three-head button" href="{{route('login')}}"><span>Login</span></a>
                            </li>
                            <li class="nav-item">
                ...
                <div class="row ">
                    ...
                    <div class="col-xl-6 col-lg-4 col-md-6 col-12" data-aos="fade-up">
                        <div class="girl-slide-img aos">
                            <img class="img-fluid" src="{{asset('frontend/assets/img/slider/home-slider.png')}}" alt="Img">
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="align-items-center">
                                    <div class="course-count-three course-count ms-0">
                                        <div class="course-img">
                                            <img class="img-fluid" src="{{asset('frontend/assets/img/icon-three/course-01.svg')}}" alt="Img">
                                        </div>
                        ...
                        <div class="col-lg-3 col-md-6 d-flex" data-aos="fade-up">
                            <div class="course-details-three">
                                <div class="align-items-center">
                                    <div class="course-count-three course-count ms-0">
                                        <div class="course-img">
                                            <img class="img-fluid" src="{{asset('frontend/assets/img/icon-three/course-02.svg')}}" alt="Img">
                                        </div>
                                        <div class="course-content-three">
                        ...
                        <div class="col-lg-3 col-md-6 d-flex" data-aos="fade-up">
                            <div class="course-details-three">
                                <div class="align-items-center">
                                    <div class="course-count-three course-count ms-0">
                                        <div class="course-img">
                                            <img class="img-fluid" src="{{asset('frontend/assets/img/icon-three/course-03.svg')}}" alt="Img">
                                        </div>
                                        <div class="course-content-three">
                            ...
                            <div class="course-details-three mb-0">
                                <div class="align-items-center">
                                    <div class="course-count-three">
                                        <div class="course-img">
                                            <img class="img-fluid" src="{{asset('frontend/assets/img/icon-three/course-04.svg')}}" alt="Img">
                                        </div>
        ...
        <section class="master-skill-three">
            <div class="master-three-vector">
                <img class="ellipse-right img-fluid" src="{{asset('frontend/assets/img/bg/pattern-01.png')}}" alt="Img">
            </div>
            <div class="container">
                <div class="row">
                                                            ...
                                                            <div class="course-three-img">
                                                                <a href="course-details.html">
                                                                    <img class="img-fluid" alt="Img"
                                                                        src="{{asset('frontend/assets/img/course/course-26.jpg')}}">
                                                                </a>
                                                            </div>
                                                    ...
                                                    <div class="course-box-three">
                                                        <div class="course-three-item">
                                                            <div class="course-three-img">
                                                                <a href="course-details.html">
                                                                    <img class="img-fluid" alt="Img"
                                                                        src="{{asset('frontend/assets/img/course/course-21.jpg')}}">
                                                                </a>
                                                            </div>
                                                            <div class="course-three-content">
                                                                <div class="course-group-three">
                                                    ...
                                                    <div class="course-box-three">
                                                        <div class="course-three-item">
                                                            <div class="course-three-img">
                                                                <a href="course-details.html">
                                                                    <img class="img-fluid" alt="Img"
                                                                        src="{{asset('frontend/assets/img/course/course-22.jpg')}}">
                                                                </a>
                                                            </div>
                                                            <div class="course-three-content">
                                                                <div class="course-group-three">
        ...
        <section class="home-three-goals">
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-4 col-12" data-aos="fade-down">
                        <div class="acheive-goals">
                            <div class="acheive-elips-one">
                                <img src="{{asset('frontend/assets/img/icon-three/ellipse-1.svg')}}" alt="Img">
                            </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-4 col-12" data-aos="fade-down">
                        <div class="acheive-goals">
                            <div class="{{asset('frontend/acheive-elips-two')}}">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-4 col-12" data-aos="fade-down">
                        <div class="acheive-goals">
                            <div class="acheive-elips-three">
                                <img src="{{asset('frontend/assets/img/icon-three/ellipse-3.svg')}}" alt="Img">
                            </div>
                            <div class="acheive-goals-content text-center course-count ms-0">
        ...
        <section class="accelerate-cloud-three">
            <div class="container">
                <div class="shapes-three-right">
                    <img class="accelerate-one" src="{{asset('frontend/assets/img/bg/shape-1.png')}}" alt="Img">
                    <img class="accelerate-two" src="{{asset('frontend/assets/img/bg/pattern-03.png')}}" alt="Img">
                </div>
                <div class="shapes-three-left">
                    <img class="accelerate-three" src="{{asset('frontend/assets/img/bg/pattern-02.png')}}" alt="Img">
                    <img class="accelerate-four" src="{{asset('frontend/assets/img/bg/shape-2.png')}}" alt="Img">
                    <img class="accelerate-five" src="{{asset('frontend/assets/img/bg/pattern-04.png')}}" alt="Img">
                </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-12" data-aos="fade-right">
                            <div class="award-three-images-one">
                                <img class="img-fluid" src="{{asset('frontend/assets/img/students/award-01.png')}}" alt="image-banner"
                                    title="image-banner">
                            </div>
                        </div>
                            ...
                            <div class="trending-content-top trending-bg-two">
                                ...
                                <div class="trending-counts-info d-flex align-items-center justify-content-between">
                                    <div class="trending-three-counts d-flex align-items-center">
                                        <img src="{{asset('frontend/assets/img/icon-three/student-icon.svg')}}" alt="Img">
                                        <p>900 Students</p>
                                    </div>
                    ...
                    <div class="row">
                            ...
                            <div class="row">
                                    ...
                                    <div class="gallery-three-img-item">
                                        <div class="content-three-main">
                                            <div class="gallery-img">
                                                <img src="{{asset('frontend/assets/img/gallery/gallery-1.jpg')}}" alt="Instructor">
                                            </div>
                                ...
                                <div class="col-lg-5 col-md-5">
                                    <div class="gallery-three-img-item">
                                        <div class="content-three-main">
                                            <div class="gallery-img">
                                                <img src="{{asset('frontend/assets/img/gallery/gallery-2.jpg')}}" alt="Instructor">
                                            </div>
                                            <div class="content-three-overlay">
                                                <div class="content-three-text">
                                                    <div>
                                ...
                                <div class="col-lg-5 col-md-5">
                                    <div class="gallery-three-img-item mb-0">
                                        <div class="content-three-main">
                                            <div class="gallery-img">
                                                <img src="{{asset('frontend/assets/img/gallery/gallery-3.jpg')}}" alt="Instructor">
                                            </div>
                                            <div class="content-three-overlay">
                                                <div class="content-three-text">
                                                    <div>
                                ...
                                <div class="col-lg-7 col-md-7">
                                    <div class="gallery-three-img-item mb-0">
                                        <div class="content-three-main">
                                            <div class="gallery-img">
                                                <img src="{{asset('frontend/assets/img/gallery/gallery-4.jpg')}}" alt="Instructor">
                                            </div>
                                            <div class="content-three-overlay">
                                                <div class="content-three-text">
                                                    <div>
                        ...
                        <div class="col-lg-3 col-md-3">
                            <div class="gallery-three-img-item mb-0">
                                <div class="content-three-main">
                                    <div class="gallery-img">
                                        <img src="{{asset('frontend/assets/img/gallery/gallery-5.jpg')}}" alt="Instructor">
                                    </div>
                                    <div class="content-three-overlay">
                                        <div class="content-three-text">
                                            <div>
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12">
                                    <div class="gallery-three-img-item">
                                        <div class="content-three-main">
                                            <div class="gallery-img">
                                                <img src="{{asset('frontend/assets/img/gallery/gallery-6.jpg')}}" alt="Instructor">
                                            </div>
                                            <div class="content-three-overlay">
                                                <div class="content-three-text">
                                                    <div>
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="gallery-three-img-item mb-0">
                                        <div class="content-three-main">
                                            <div class="gallery-img">
                                                <img src="{{asset('frontend/assets/img/gallery/gallery-7.jpg')}}" alt="Instructor">
                                            </div>
                                            <div class="content-three-overlay">
                                                <div class="content-three-text">
                                                    <div>
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="gallery-three-img-item mb-0">
                                        <div class="content-three-main">
                                            <div class="gallery-img">
                                                <img src="{{asset('frontend/assets/img/gallery/gallery-8.jpg')}}" alt="Instructor">
                                            </div>
                                            <div class="content-three-overlay">
                                                <div class="content-three-text">
                                                    <div>
            ...
            <div class="container">
                ...
                <div class="m-0 p-0 lead-group aos" data-aos="fade-up">
                    <div class="lead-group-slider owl-carousel owl-theme">
                        <div class="item">
                            <div class="lead-img">
                                <img class="img-fluid" alt="Img" src="{{asset('frontend/assets/img/ccgroup.png')}}">
                            </div>
                        </div>
                        <div class="item">
                            <div class="lead-img">
                                <img class="img-fluid" alt="Img" src="{{asset('frontend/assets/img/laika-logo.png')}}">
                            </div>
                        </div>
                        <div class="item">
                            <div class="lead-img">
                                <img class="img-fluid" alt="Img" src="{{asset('frontend/assets/img/lead-03.png')}}">
                            </div>
                        </div>
                        <div class="item">
                            <div class="lead-img">
                                <img class="img-fluid" alt="Img" src="{{asset('frontend/assets/img/lead-04.png')}}">
                            </div>
                        </div>
                        <div class="item">
                            <div class="lead-img">
                                <img class="img-fluid" alt="Img" src="{{asset('frontend/assets/img/lead-05.png')}}">
                            </div>
                        </div>
                        <div class="item">
                            <div class="lead-img">
                                <img class="img-fluid" alt="Img" src="{{asset('frontend/assets/img/lead-06.png')}}">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="testimonial-three">
            <div class="container">
                <div class="testimonial-pattern">
                    <img class="pattern-left img-fluid" alt="Img" src="{{asset('frontend/assets/img/bg/pattern-05.svg')}}">
                    <img class="pattern-right img-fluid" alt="Img" src="{{asset('frontend/assets/img/bg/pattern-06.svg')}}">
                </div>
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="testimonial-item-five">
                                            <div class="testimonial-quote">
                                                <img class="quote img-fluid" alt="Img" src="{{asset('frontend/assets/img/bg/quote.svg')}}">
                                            </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="testimonial-item-five">
                                            ...
                                            <div class="testimonial-users">
                                                <div class="imgbx">
                                                    <img class alt="Img" src="{{asset('frontend/assets/img/profiles/avatar-01.jpg')}}">
                                                </div>
                                                <div class="d-block">
                                                    <h6>Sumit Khadka</h6>
                                                    <p>Web developer</p>
                            ...
                            <div class="row">
                                    ...
                                    <div class="event-blog-three blog-three-one">
                                        <div class="blog-img-three">
                                            <a href="blog-list.html">
                                                <img class="img-fluid" alt="Img" src="{{asset('frontend/assets/img/blog/blog-20.jpg')}}">
                                            </a>
                                        </div>
                                ...
                                <div class="col-md-12" data-aos="fade-down">
                                    <div class="event-blog-three blog-three-two">
                                        <div class="blog-img-three">
                                            <a href="blog-list.html">
                                                <img class="img-fluid" alt="Img" src="{{asset('frontend/assets/img/blog/blog-21.jpg')}}">
                                            </a>
                                        </div>
                                        <div class="latest-blog-content">
                                            <div class="event-three-title">
                            ...
                            <div class="row">
                                <div class="col-md-12" data-aos="fade-down">
                                    <div class="event-blog-three blog-three-three">
                                        <div class="blog-img-three">
                                            <a href="blog-list.html">
                                                <img class="img-fluid" alt="Img" src="{{asset('frontend/assets/img/blog/blog-22.jpg')}}">
                                            </a>
                                        </div>
                                        <div class="latest-blog-content">
                                            <div class="event-three-title">
                                ...
                                <div class="col-md-12" data-aos="fade-down">
                                    <div class="event-blog-three blog-three-four">
                                        <div class="blog-img-three">
                                            <a href="blog-list.html">
                                                <img class="img-fluid" alt="Img" src="{{asset('frontend/assets/img/blog/blog-23.jpg')}}">
                                            </a>
                                        </div>
                                        <div class="latest-blog-content">
                                            <div class="event-three-title">
                                ...
                                <div class="col-md-12" data-aos="fade-down">
                                    <div class="event-blog-three blog-three-five">
                                        <div class="blog-img-three">
                                            <a href="blog-list.html">
                                                <img class="img-fluid" alt="Img" src="{{asset('frontend/assets/img/blog/blog-24.jpg')}}">
                                            </a>
                                        </div>
                                        <div class="latest-blog-content">
                                            <div class="event-three-title">
                            ...
                            <div class="col-lg-6 col-md-6 col-12">
                                ...
                                <div class="footer-widget-three footer-about">
                                    <div class="footer-three-logo">
                                        <img class="img-fluid" src="{{asset('frontend/logo.png')}}" alt="logo" style="filter: invert(1);">
                                    </div>
    ...
    <script src="{{asset('frontend/assets/js/jquery-3.7.1.min.js')}}" type="a860e97a09b072416dbc7e62-text/javascript"></script>

    <script src="{{asset('frontend/assets/js/bootstrap.bundle.min.js')}}" type="a860e97a09b072416dbc7e62-text/javascript"></script>

    <script src="{{asset('frontend/assets/js/owl.carousel.min.js')}}" type="a860e97a09b072416dbc7e62-text/javascript"></script>

    <script src="{{asset('frontend/assets/plugins/aos/aos.js')}}" type="a860e97a09b072416dbc7e62-text/javascript"></script>

    <script src="{{asset('frontend/assets/js/jquery.waypoints.js')}}" type="a860e97a09b072416dbc7e62-text/javascript"></script>
    <script src="{{asset('frontend/assets/js/jquery.counterup.min.js')}}" type="a860e97a09b072416dbc7e62-text/javascript"></script>

    <script src="{{asset('frontend/assets/plugins/select2/js/select2.min.js')}}" type="a860e97a09b072416dbc7e62-text/javascript"></script>

    <script src="{{asset('frontend/assets/plugins/slick/slick.js')}}" type="a860e97a09b072416dbc7e62-text/javascript"></script>

    <script src="{{asset('frontend/assets/plugins/swiper/js/swiper.min.js')}}" type="a860e97a09b072416dbc7e62-text/javascript"></script>

    <script src="{{asset('frontend/assets/js/script.js')}}" type="a860e97a09b072416dbc7e62-text/javascript"></script>
    <script src="{{asset('frontend/assets/cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js')}}"
