    ...
    <div class="page-inner">
        <div class="page-header">
            ...
            <div class="float-right">
                <a href="<?php echo e(route('permissions.index')); ?>" class="btn btn-primary">List Permissions</a>
            </div>
...
<?php echo $__env->make('layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\institute\institute-management\resources\views/backend/permissions/create.blade.php ENDPATH**/ ?>