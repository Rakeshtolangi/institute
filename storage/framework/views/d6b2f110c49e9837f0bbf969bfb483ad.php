    ...
    <div class="page-inner">
        <div class="page-header">
            ...
            <div class="float-right">
                <a href="<?php echo e(route('roles.index')); ?>" class="btn btn-primary">List Users</a>
            </div>
...
unset($__errorArgs, $__bag); ?>" multiple
                                            ...
                                            <?php if($role!='Super Admin' && $role!='Teacher'): ?>
...
<?php echo $__env->make('layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Projects\institute\institute-management\resources\views/backend/users/edit.blade.php ENDPATH**/ ?>